...
\begin{document}
	...
	\begin{titlepage}
		...
		\begin{center}
			...
			\textup{FixMi \\ Documento di Architettura}\\
		\end{center}
...
\begin{itemize}
	...
	\item "Abstract": Una classe abstract non viene mai istanziata, viene perciò usata per effettuare templating e venire estesa da altre classi.
...
\begin{itemize}
    \item Porta il dipendente nella pagina per gestire le Task.
\end{itemize}
\iffalse
