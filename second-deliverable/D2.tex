...
\begin{figure}[H]
	\centering\includegraphics[width=1\textwidth]{images/RF6_riparazione_UCD.png}
	Use Case Diagram di RF6 "Riparazione"
\end{figure}
...
\begin{figure}[H]
	\centering\includegraphics[width=1\textwidth]{images/RF7_assistenza_UCD.png}
\end{figure}
