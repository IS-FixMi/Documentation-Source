...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{figure}[H]
			\centering\includegraphics[width=1\textwidth]{images/microservizio-autenticazione/frontend/login-carbon.png}
			Codice del componente "login.tsx"
		\end{figure}
	\end{itemize}
	\item formLogin.tsx
	\begin{itemize}
...
\begin{figure}[H]
	...
	\caption{Schermata per il profilo}
\end{figure}
