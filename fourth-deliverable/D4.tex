...
La risorsa "Scegli Task", accessibile tramite la route "/api/tasks/scegliTask" permette di assegnare una task ad un dipendente o ad un manager. L'API richiede i seguenti campi:
...
\begin{center} % center the table
	...
	\begin{tabular}{ |p{4cm}|p{4cm}|p{4cm}| }
		...
		\hline
		400 BAD REQUEST & \{ error: "task not found" \} & Il valore "taskId" inviato non è valido \\
		\hline
