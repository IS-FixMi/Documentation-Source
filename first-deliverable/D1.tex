...
\end{enumerate}
	...
	Il sito deve offrire la possibilità al cliente di cambiare password: \\
	Il sistema chiede al cliente di inserire l'email associata al profilo di cui si vuole cambiare password, dopodichè verrà inviato un codice 2FA a suddetta e-mail. Inserito il codice corretto il sistema permetterà al cliente di inserire la nuova password.
	\begin{enumerate}
...
Il sito presenta all’utente una pagina "Negozio”: 
