...
\begin{enumerate}
	...
	\begin{itemize}
		\item Il sito deve utilizzare un sistema di hashing delle password per il controllo e la memorizzazione
		\item Il sito deve utilizzare i protocolli tls e https per la comunicazione, come specificato nel capitolo 3.2-Design del back-end
	\end{itemize}
